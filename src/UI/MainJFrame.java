...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ControlJPanel.add(assignBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 140, 30));

        createObservationBtn.setText("CREATE ");
        createObservationBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                createObservationBtnActionPerformed(evt);
            }
        });
        ControlJPanel.add(createObservationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 140, 30));

        viewVitalsBtn.setText("VIEW ");
        viewVitalsBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewVitalsBtnActionPerformed(evt);
            }
        });
        ControlJPanel.add(viewVitalsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 140, 30));

        medCatalogBtn.setText(" CATALOG");
        medCatalogBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                medCatalogBtnActionPerformed(evt);
            }
        });
        ControlJPanel.add(medCatalogBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 140, 30));
